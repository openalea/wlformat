...
Ready to contribute? Here's how to set up `wlformat` for local development.

1. Fork the `wlformat` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/wlformat.git
...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd wlformat
    (dvlpt) wlformat$ flake8
    (dvlpt) wlformat$ nosetests
    (dvlpt) wlformat$ tox
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/openalea/wlformat/pull_requests
...
.. _issues: https://github.com/openalea/wlformat/issues
