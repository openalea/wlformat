...
# -*- coding: utf-8 -*-
#
# Package wlformat documentation build configuration file, created by
...
# version is used.
sys.path.insert(0, os.path.join(project_root, os.path.dirname('src/openalea/wlformat')))

# import wlformat as mypkg
...
project = u'openalea.wlformat'
copyright = u'2015, openalea.wlformat'
